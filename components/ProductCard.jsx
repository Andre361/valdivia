...
function ProductCard1({ product }) {
  ...
  return (
    <div className="product-card border-solid border-gray-200 border-2 bg-red-100 basis-1/5 lg:w-full">
...
function ProductCard({ product }) {
  const placeholderImage =
    "https://res.cloudinary.com/dsuqfsnp2/image/upload/v1658883630/cld-sample-4.jpg";
  return (
    <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
      <a href="#">
        <Image
